...
with_node \
  ...
  --target "/Users/mac/Desktop/www/LEAP-ANDY/Leap/ios/Pods/Target Support Files/Pods-Leap/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router"
